...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [528048.927634, 5444425.422586, 549132.602318, 5466267.825483], maxZoom: 14, minZoom: 5
    })
});


map.getView().fit([528048.927634, 5444425.422586, 549132.602318, 5466267.825483], map.getSize());
